...
class Solicitante(BaseModel):
    ...
    """
    tipo_documento = models.CharField(max_length=45, choices=tipo_documento, default='V',null=False, blank=False, verbose_name='Tipo de documento')

    fecha_registro = models.DateTimeField(auto_now_add=True, null=True, blank=True)
    fecha_actulizacion = models.DateTimeField(auto_now=True, null=True, blank=True)
    ...
    def toJSON(self):
        ...
        item['fecha_actulizacion'] = self.fecha_actulizacion.strftime('%Y-%m-%d %H:%M:%S')
        item['full_name'] = self.get_full_name()
        item['full_contact'] = '{} / {}'.format(self.telefono, self.correo_electronico)
